                ...
                <div class="col d-flex flex-column align-items-center justify-content-center">
                    <form>
                        <div class="mb-3">
                            ...
                            <div id="emailHelp" class="form-text text-danger user message-empty d-none" data-hidden>All fields must be filled.</div>
                            <div id="emailHelp" class="form-text text-danger user-incorrect d-none" data-hidden>User not found.</div>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="password" class="form-control" id="password" name="password">
                            <div id="emailHelp" class="form-text text-danger password message-empty d-none" data-hidden>All fields must be filled.</div>
                            <div id="emailHelp" class="form-text text-danger password-incorrect d-none" data-hidden>Password incorrect.</div>
                        </div>
