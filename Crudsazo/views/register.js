                ...
                <div class="col d-flex flex-column align-items-center justify-content-center">
                    <form>
                        <div class="mb-3">
                            ...
                            <div id="emailHelp" class="form-text text-danger username d-none" data-hidden >All fields must be filled.</div>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email">
                            <div id="emailHelp" class="form-text text-danger email d-none" data-hidden >All fields must be filled.</div>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="password" class="form-control" id="password" name="password">
                            <div id="emailHelp" class="form-text text-danger password d-none" data-hidden >All fields must be filled.</div>
                        </div>
                        <div class="mb-3">
                            <label for="passwordConfirm" class="form-label">Confirm Password</label>
                            <input type="password" class="form-control" id="passwordConfirm" name="passwordConfirm">
                            <div id="emailHelp" class="form-text text-danger passwordConfirm d-none" data-hidden >All fields must be filled.</div>
                            <div id="emailHelp" class="form-text text-danger no-match d-none" data-hidden >Passwords do not match.</div>
                        </div>
                        <button type="submit" class="btn btn-primary" id="register-button">Create</button>
                        <div id="emailHelp" class="form-text text-danger username-unavailable d-none" data-hidden >There is already an account with that name.</div>
                        <div id="emailHelp" class="form-text text-danger email-unavailable d-none" data-hidden >There is already an account with that email.</div>
                    </form>
                </div>
            </div>
        </section>  
